...
public class TransactionsService {
    ...
    public List<GetTransactionResponse> getAllTransactions(int accountId, CustomUserDetails userDetails){
        ...
        List<Transactions> transactions = transactionsRepoInterface.findAllByAccountId(account.getAccountId()).orElseThrow(() -> new NotFoundException("Transaction Not Found"));
